                    ...
                    <div class="container-fluid mt-2">    
                            <div class="container mb-3">
                                <div class="card bg-white shadow p-4 mb-4"> 
                                    <div class="row">
                                        <div class="col-8">
                                            <h2 style="font-weight: 400"> History SPP </h2>
                                        </div>
                                        <div class="col-4">
                                            <button type="button" class="btn btn-secondary ms-5 ">Tambah Data</button>
                    ...
                    <div class="container-fluid mt-2">    
                        <div class="container mb-3">
                            <div class="card bg-white shadow p-4 mb-4">
                                <div class="row">
                                    <div class="col-8">
                                        <h2 style="font-weight: 400"> History Uang Pangkal </h2>
                                    </div>
                                    <div class="col-4">
