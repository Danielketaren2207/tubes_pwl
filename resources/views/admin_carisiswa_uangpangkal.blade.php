            ...
            <div id="content">
                ...
                <div id="page-content-wrapper">
                    <div class="container-fluid mt-4">
                        <h2 class="subjudul ms-2 mb-3" >Cari Siswa yang Ingin Membayar Uang Pangkal</h2>
                                            ...
                                            <tbody>
                                                @foreach ($datasiswa as $item)
                                                    <tr>
                                                        ...
                                                        <td> {{$item->name}}</td>
                                                        <td> {{$item->email}}</td>
                                                        <td><a href="{{ route('admin_up' , $item->id) }}"> <button type="button" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i> Perbarui Data</button> </a>
