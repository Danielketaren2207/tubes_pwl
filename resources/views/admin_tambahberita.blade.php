            ...
            <div id="content">
                ...
                <div id="page-content-wrapper">
                    <div class="container-fluid mt-4">
                        <h2 class="subjudul ms-2 mb-3" > Tambah Berita </h2>
        
                            <div class="container mb-3">
                                <div class="card bg-white shadow p-4 mb-4">


                                    <form action="{{  route('admin_tambahberita_simpan')  }}" method="POST" enctype="multipart/form-data">
                                        @csrf

                                        <div class="mb-3">
                                          <label for="title" class="form-label">Title</label>
                                          <input type="text" class="form-control" name="title" required placeholder="Judul Berita">
                                        </div>

                                        <div class="mb-3">
                                            <label for="description" class="form-label">Description</label>
                                            <textarea type="text" class="form-control" name="caption" required placeholder="Dekripsi Berita"></textarea>
                                          </div>
