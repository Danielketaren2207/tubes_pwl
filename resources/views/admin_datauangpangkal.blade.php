            ...
            <div id="content">
                ...
                <div id="page-content-wrapper">
                    <div class="container-fluid mt-4">
                        <h2 class="subjudul"> Data Uang Pangkal </h2>
                        @if(session('message'))
                        ...
                        <div class="container mb-3">
                            ...
                            <div class="container mb-3">
                                <div class="card bg-white shadow p-4 mb-4">
                                    ...
                                    <div id="page-content-wrapper">
                                        <h4>Histori Pembayaran Uang Pangkal</h4>
                                        <h6>Biaya uang pangkal yang telah ditetapkan berjumlah Rp 1.000.000, pastikan pembayaran ke 10 total pembayaran sudah genap Rp 1.000.000</h6>
                                        <table class="table">
                                            <thead>
                                                <tr>
                                        ...
                                        <tbody>
                                                @foreach ($histori_up as $hu)
                                                    <tr>
                                                        <td>{{$hu->pembayaran_ke}}</td>
                                                        <td>{{$hu->nominal}}</td>                                                        
                                                        <td>
                                                            <a href="{{ route('up_delete' , $hu->id) }}" class="btn btn-danger"><i class="fa-solid fa-trash"></i> Hapus</a>
                                                        </td>
                                    ...
                                    <div class="container mb-3 px-5">
                                        <div class=" card bg-white shadow p-4 mb-4"> 
                                            ...
                                            <form method="POST" action="{{  route('up_create')  }}">
                                                @csrf  
                                                <input type="hidden" name="id" value="{{$nim}}" >
                                                
                                                <h6>Pembayaran ke</h6>
                                                
                                                <select class="form-select form-control" name="cicilan" aria-label="Default select example">
